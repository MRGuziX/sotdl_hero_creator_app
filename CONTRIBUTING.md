...
and
open a pull request (PR). You don’t need to fork if you can push branches here. Keep PRs focused; one feature or fix per
PR is easier to review.

**Improve documentation** – Fixes and clarifications in the README, agent docs, or code comments are always welcome. Use
the
docs: prefix in your commit (see below).

**Add or fix tests** – If you add or change behavior, consider adding or updating tests and use the test: prefix in
commits.
...
We encourage Conventional Commits so that history and release notes stay clear.
